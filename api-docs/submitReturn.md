...
Submits a return for the user for a specific period if the user is lock holder.
...
| dutyDeclared.dutyDue                                             | The duty due details                                               | Object       | Mandatory          |                                                                                                |
| dutyDeclared.dutyDue.taxCode                                     | The three digit tax code                                           | String       | Mandatory          |                                                                                                |
...
| adjustments.overDeclarationProducts.adjustmentQuantity           | The quantity to be adjusted                                        | Object       | Mandatory          |                                                                                                |  
...
| adjustments.overDeclarationProducts.dutyDue.taxCode              | The three digit tax code                                           | String       | Mandatory          |                                                                                                |
...
| adjustments.underDeclarationProducts.adjustmentQuantity          | The quantity to be adjusted                                        | Object       | Mandatory          |                                                                                                |  
...
| adjustments.underDeclarationProducts.dutyDue.taxCode             | The three digit tax code                                           | String       | Mandatory          |                                                                                                |
...
| adjustments.spoiltProducts.adjustmentQuantity                    | The quantity to be adjusted                                        | Object       | Mandatory          |                                                                                                |  
...
| adjustments.spoiltProducts.dutyDue.taxCode                       | The three digit tax code                                           | String       | Mandatory          |                                                                                                |
...
| adjustments.drawbackProducts.adjustmentQuantity                  | The quantity to be adjusted                                        | Object       | Mandatory          |                                                                                                |  
...
| adjustments.drawbackProducts.dutyDue.taxCode                     | The three digit tax code                                           | String       | Mandatory          |                                                                                                |
...
| adjustments.repackagedDraughtProducts.repackagedQuantity         | The quantity to be adjusted                                        | Object       | Mandatory          |                                                                                                |  
...
| dutySuspended.dutySuspendedProducts.suspendedQuantity            | The quantity to be suspended                                       | Object       | Mandatory          |                                                                                                |  
...
| spirits.spiritsProduced.typesOfSpirit                            | The types of spirit produced                                       | Set(Enum)    | Mandatory          | Malt, Grain, NeutralAgricultural, NeutralIndustrial, Beer, CiderOrPerry, WineOrMadeWine, Other |
...
| spirits.spiritsProduced.grainsQuantities.rye                     | Quantity of rye used                                               | Numeric      | Mandatory          |                                                                                                |                                             |
...
The response body returns the details of the submitted return.
...
| paymentDueDate                                             | The date the payment is due          | Date      | Optional           | YYYY-MM-DD Present if there is an amount to pay |
