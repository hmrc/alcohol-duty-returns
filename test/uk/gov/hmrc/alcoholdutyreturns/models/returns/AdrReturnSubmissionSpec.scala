...
class AdrReturnSubmissionSpec extends SpecBase {
  ...
  "AdrReturnSubmission must" - {
    "serialise to json" in new SetUp {
      Json.toJson(adrReturnSubmission).toString() mustBe adrReturnSubmissionJson
    }
  ...
  "AdrReturnCreatedDetails must" - {
    ...
    "deserialise from json" in new SetUp {
      Json.parse(adrReturnCreatedDetailsJson).as[AdrReturnCreatedDetails] mustBe adrReturnCreatedDetails
    }
    ...
    "deserialise from json with minimal payload" in new SetUp {
      Json.parse(adrReturnCreatedDetailsMinimalJson).as[AdrReturnCreatedDetails] mustBe adrReturnCreatedDetailsMinimal
    }
