...
class AdrReturnSubmissionSpec extends SpecBase {
  ...
  class SetUp {
    ...
    val adrReturnCreatedDetailsJson =
      s"""{"processingDate":"2024-06-11T15:07:47.838Z","amount":$total,"chargeReference":"$chargeRef","paymentDueDate":"2024-04-25"}"""

    val adrReturnSubmission     = exampleReturnSubmissionRequest
    val returnCreatedDetails    =
      exampleReturnCreatedSuccessfulResponse(periodKey, total, now, chargeRef, submission).success
